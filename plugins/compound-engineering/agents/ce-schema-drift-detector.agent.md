...
<<<<<<< HEAD:plugins/compound-engineering/agents/review/schema-drift-detector.md
<examples>
<example>
...
=======
>>>>>>> upstream/main:plugins/compound-engineering/agents/ce-schema-drift-detector.agent.md
